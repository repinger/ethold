...
- `(tn *TelegramNotifier) SetReplyKeyboard(buttons [][]string)`: Configures a persistent custom keyboard (`ReplyKeyboardMarkup`) attached to interactive command replies.
